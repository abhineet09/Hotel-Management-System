...
<div id="book_taxi" style="position: relative;top:290px;">
          <img src="hotel/polo2.png" alt="Company's Logo" style="position: relative;top:-750px;left:420px">
          <img src="hotel/pool1.png" alt="Company's Logo" style="height: 100px;width:100px;position: relative;top:-735px;left:-280px">
            ...
            <form>
              <div style="position: relative;left: 30px;color: white">
                ...
                <input type="text" name="phone">
                  <div style="position: relative;top:-50px;left: 630px"><a>Activities:</a> <select name="nop"></div>
                                <?php
                                  $act=array("POOL TABLE","SWIMMING","VOLLEYBALL");
                                  foreach($act as $r ) { ?>
                ...
                <div style="position: relative;top:-80px;left: 540px"><a style="position: relative;left: 70px">TIME:</a> <input type="time" name="book_time" style="position: relative;left:90px;top:-10px">
...
<div id="services" style="position: relative;height: 610px;top:180px">
    <div id="box" style="height: 410px;width: 400px;border: 5px solid black;position: relative;right:-10px">
      <a href="./"><img src="./hotel/pic26.jpg" alt="twitterLogo" style="height:300px;width:100%;"></a>
