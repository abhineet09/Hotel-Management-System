...
<?php
  ...
  if(isset($_POST["submit"])){
    ...
    $dt=$_POST["date"];
    $tm=$_POST["time"];
    $sql="INSERT into restaurant values('restaurant','$myUs','$ph[0]','$dt','$tm','$np',NULL);";
...
<div id="container">
    <div id="book_taxi">
          <img src="hotel/kingsmen.jpg" alt="Company's Logo" style="width:100%;height:100%;opacity: 0.5">
          
          <div id="book_table" style="width: 90%;height: 500px;position: relative;top: -785px;left:100px;">
              <img src="hotel/dine1.png" alt="Company's Logo" style="position: relative;top:-80px;left:250px">
              <img src="hotel/res1.png" alt="Company's Logo" style="height: 200px;width:200px;position: relative;top:0px;left:-700px">
              <form method="post" action="./restaurant.php">
                ...
                <a style="position: relative;left: 70px">TIME:</a> <select name="time" style="position: relative;left: 70px">
                                <?php
                                  foreach($tm as $r ) {
                  ...
                  <input type="submit" name="submit" value="" style="background-image: url('./hotel/booknow.jpg');background-size:100% 100%;position: relative;top: 110px;left:-70px;height: 60px;width: 250px">
              </form>
              
          </div>
          <div id="current_booking" style="width: 80%;height: 100px;position: relative;top:-900px;left: 100px">
              <?php
                $sql="SELECT no_of_people,book_date,time_hrs from restaurant where book_id=$myUs;";
...
<div id="rest_menu" style="background-color: black;height: 70px;width: 80.7%;position: fixed;top:60px;left:278px">
  <div id="rest_option" style="position: relative;top:30px;left:50px">
      <a href="restaurant.php" style="color: yellow">KINGSMEN RESTAURANT</a>
