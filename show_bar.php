...
?>
  <?php
    ...
    $dt=$_POST["date"];
    $tm=$_POST["time"];
    $sql="INSERT into bar values('bar','10','$ph','$dt','$tm','$np',NULL);";
    if(mysqli_query($con,$sql)){
...
<div id="menu_link" style="position: relative;top:-135px;left: 1100px">
  <a href="./menu2.php" style="text-decoration:none;"><img src="hotel/menu_icon.jpg" alt="Company's Logo" style="height: 100px;width: 100px"></a>
...
<div id="book_taxi" style="position: relative;top:290px;">
          <img src="hotel/bar3.png" alt="Company's Logo" style="position: relative;top:-750px;left:420px">
          <img src="hotel/bar2.png" alt="Company's Logo" style="height: 100px;width:100px;position: relative;top:-735px;left:-280px">
          <div id="book_table" style="width: 80%;height: 400px;position: relative;top: -685px;left:100px;">
            ...
            <form method="post" action="./show_bar.php">
              <div style="position: relative;left: 30px;color: white">
                ...
                <div style="position: relative;top:-80px;left: 540px"><a style="position: relative;left: 70px">TIME:</a> <input type="time" name="time" style="position: relative;left:90px;top:-10px">
          ...
          <div id="book_details" style="width: 100%;height: 200px;position: relative;top: 50px;left:-30px;">
              ...
              <form method="post" action="./show_bar.php" style="position: relative;left: 30px">
                  <a>PHONE NUMBER:</a>
               ...
               <?php
                if(isset($_POST["chk_details"])){
                  $phn=$_POST["phone1"];
                $sql="SELECT no_of_people,book_date,time_hrs from bar where phone_no=$phn;";
