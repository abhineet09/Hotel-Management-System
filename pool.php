...
<?php
  ...
  if(isset($_POST["submit"])){
    ...
    $dt=$_POST["date"];
    $tm=$_POST["time"];
    $sql="INSERT into lounge values('lounge','$myUs','$ph[0]','$dt','$tm','$act',NULL);";
  ...
  $act=array("POOL","SWIMMING","VOLLEYBALL");
?>
<header>
    <div id='nav'>
      <ul>
...
<div id="container">
    <div id="book_taxi">
          ...
          <div id="book_table" style="width: 90%;height: 500px;position: relative;top: -795px;left:100px;">
              <img src="hotel/polo2.png" alt="Company's Logo" style="position: relative;top:-80px;left:250px">
              <img src="hotel/pool1.png" alt="Company's Logo" style="height: 200px;width:200px;position: relative;top:0px;left:-540px">
              <form method="post" action="./pool.php" style="position: relative;top:-20px;">
                <a>ACTIVITIES: </a> <select name="act">
                                <?php
                                  foreach($act as $at){ ?>
          ...
          <div id="current_booking" style="width: 80%;height: 100px;position: relative;top:-950px;left: 100px">
              <?php
                $sql="SELECT activity,book_date,time_hrs from lounge where book_id=$myUs;";
                $qw=mysqli_query($con,$sql);
              if(mysqli_affected_rows($con)>0){
                echo "<h1>YOUR CURRENT BOOKINGS:<br><br>";
                echo "<table border=1 style='width:700px'><tr><th><a>ACTIVITY</a></th><th>DATE</th><th>TIME</th></tr>";
...
<div id="rest_menu" style="background-color: black;height: 70px;width: 80.7%;position: fixed;top:60px;left:278px">
  <div id="rest_option" style="position: relative;top:30px;left:50px">
      ...
      <a href="pool.php" style="color: yellow">POOL LOUNGE</a>
