<html>
<head>
<title>The Beverely Hills Hotel</title><link rel="icon" href="./images/icon.ico">
...
<?php
  include('session.php');
  $avail=array("01:00:00 PM","02:00:00 PM","03:00:00 PM","04:00:00 PM","05:00:00 PM");
  ...
  if(isset($_POST["submit"])){
    ...
    if($ch[0]==1){
    $tm=$_POST["appoint"];
    $sql="INSERT into spa values('spa','$myUs','$tm',NULL);";
...
<div id="container">
    <div id="book_taxi" style="overflow: hidden;">
          <img src="hotel/spa.jpg" alt="Company's Logo" style="width:100%;height:100%;opacity: 0.5">
          <form method="post" action="./spa.php" style="position: relative;top:-130px">
            <a style="position: relative;top: -600px;left: 130px;">APPOINTMENT FOR</a>
            ...
            <a style="position: relative;top:-745px;left:700px">SELECT TIMING</a>
            <select name="appoint" id="appoint" style="position: relative;top:-700;left: 500px">
                <?php
                  foreach($avail as $av) { ?>
            ...
            <input type="submit" name="submit" value="" style="background-image: url('./hotel/submit.jpg');background-size:100% 100%;position: relative;top: -550px;left:70px;height: 60px;width: 250px">
          </form> 
    </div>
</div>
<div style="position: relative;top: -400px;left: 300px;">
  <?php
      $sql="SELECT time_hrs from spa where book_id=$myUs;";
