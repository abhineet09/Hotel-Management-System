...
<link href='/Hotel/CSS/showRest.css' rel='stylesheet' type='text/css'></link>
...
<header>
		<div id='nav'>
			<ul>
				...
				<li><a href="#home" id="book_now"><img src="hotel/book.jpg" alt="Boking Option" style="height:40px;width:150px"></a></li>
				...
				<li><a href="#home">ABOUT US</a></li>
  				<li class="dropdown">
    				...
    				<div class="dropdown-content">
      					...
      					<a href="#">HAIR & BEAUTY SALOON</a>
    				</div>
  				</li>
  				<li class="dropdown">
    				<a href="javascript:void(0)" class="dropbtn">CUISINE</a>
    				<div class="dropdown-content">
      					<a href="#">KINGSMEN RESTAURANT</a>
      					<a href="#">BAR NINETEEN 12</a>
      					<a href="#">POOL LOUNGE</a>
      					<a href="#">CABANA COFFEE</a>
    				</div>
 				 </li>
 				 <li><a href="#news">OFFERS</a></li>
 				 <li><a href="#news">SUITES & ROOMS</a></li>
